...
def random_questionnaire_responses_gen(
    questionnaire: model.Questionnaire,
) -> Generator[model.ResponseRow, None, None]:
...
def random_questionnaire_responses_df(
    questionnaire: model.Questionnaire,
) -> pd.DataFrame:
