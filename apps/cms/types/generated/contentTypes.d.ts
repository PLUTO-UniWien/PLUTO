...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    contributorsInfo: Attribute.RichText & Attribute.Required;
    launchButtonText: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiQuestionQuestion extends Schema.CollectionType {
  ...
  attributes: {
    metadata: Attribute.Component<'question-metadata.metadata'> &
      Attribute.Required;
    choices: Attribute.Component<'answer-choice.choices', true>;
...
export interface ApiResultResult extends Schema.CollectionType {
  ...
  attributes: {
    items: Attribute.Component<'result-item.result-item', true> &
      Attribute.Required;
    metadata: Attribute.Component<'submission-metadata.submission-metadata'> &
      Attribute.Required;
...
export interface ApiResultPageResultPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    feedback: Attribute.RichText & Attribute.Required;
    resultsReadyLabel: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSurveySurvey extends Schema.CollectionType {
  ...
  attributes: {
    version: Attribute.UID & Attribute.Required & Attribute.DefaultTo<'v1.0.0'>;
    groups: Attribute.Component<'survey-group.survey-group', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
